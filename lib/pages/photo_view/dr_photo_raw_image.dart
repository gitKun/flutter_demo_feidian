...
class DRPhotoRawImage extends LeafRenderObjectWidget {
  ...
  @override
  DRRenderImage createRenderObject(BuildContext context) {
    assert((!matchTextDirection && alignment is Alignment) ||
        debugCheckHasDirectionality(context));
    return DRRenderImage(
        image: image,
        width: width,
        height: height,
        scale: scale,
  ...
  @override
  void updateRenderObject(BuildContext context, DRRenderImage renderObject) {
    renderObject
      ..image = image
      ..width = width
      ..height = height
